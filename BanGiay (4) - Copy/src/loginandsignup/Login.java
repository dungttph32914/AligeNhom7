...
public class Login extends javax.swing.JFrame {
    ...
    if(checkTT()==true){
    JOptionPane.showMessageDialog(this, "Đăng nhập thành công","Đăng nhập",1,null);
    HangHoa_View FHangHoaView=new HangHoa_View();
    FHangHoaView.setVisible(true);
    FHangHoaView.pack();
    FHangHoaView.setLocationRelativeTo(null);
    this.dispose();;}
